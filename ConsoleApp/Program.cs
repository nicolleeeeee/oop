...
namespace OOPConsole2
{
    abstract class Vehicle
    {
        ...
        public abstract int CalculatedRentalCost();
   ...
   public override void DisplayInfo()
    {
        ...
        Console.WriteLine($" Rental Cost: Php {CalculatedRentalCost()}");
    }
    public override int CalculatedRentalCost()
        {
 ...
 class Motorcycle : Vehicle
{
    ...
    public override void DisplayInfo()
    {
        ...
        Console.WriteLine($" Motorcycle Rental Cost: Php {CalculatedRentalCost()}");
    }
    public override int CalculatedRentalCost()
    {
        return hoursRented * rate;
